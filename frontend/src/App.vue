...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/budget', section: 'budget',           label: 'Προϋπολογισμός',  icon: 'M3 3v18h18M7 16l3-6 4 3 4-8', badge: 'NEW' },
  ...
  <div class="layout" :class="{ 'sidebar-collapsed': ui.sidebarCollapsed, 'mobile-menu-open': mobileMenuOpen, 'layout--auth': isAuthLayout }">
    ...
    <aside class="sidebar" v-if="!isAuthLayout">
      ...
      <div class="sidebar__bottom">
        <button class="logout-btn" @click="logout" :title="ui.sidebarCollapsed ? 'Αποσύνδεση' : ''">
          ...
          <span v-if="!ui.sidebarCollapsed">Αποσύνδεση</span>
        </button>
      </div>
