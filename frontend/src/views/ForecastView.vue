...
.forecast__control { display: flex; flex-direction: column; gap: 6px; }
...
.forecast__meta { color: #ffffff; font-size: 14px; font-weight: 500; }
...
.chart-mode-toggle button:hover { background: #1e293b; }
